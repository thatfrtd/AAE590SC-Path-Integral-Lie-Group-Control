...
% [u_k, average_cost, cost_t, cost_exit, g_k, twist_k, D_k, L_k] = ...
%     planar_path_integral_linear_lieR2( ...
%         f, B, g0, twist0, u_k, t_k, sigma, ...
%         gtarg, twisttarg, control_delta_t, ...
%         R, S_g, S_twist, lambda, ...
%         iterations, m, ...
%         f_with_control, w, noise_delta_t, ...
%         x0, tolerances);
...
%         R, S_g, S_twist, lambda, iterations, m, f_with_control, w, noise_delta_t, x0, tolerances);
