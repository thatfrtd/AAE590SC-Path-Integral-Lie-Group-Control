...
for j = 1 : iterations
    ...
    [L, cost_t(:, j), cost_exit(:, j)] = euclidean_cost(x, xtarg, u_n + delta_u, control_delta_t, eta);
    u_k = euclidean_update(u_n, delta_u, L, lambda);
