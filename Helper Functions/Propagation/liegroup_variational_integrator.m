function [g_k, twist_k, delta_u, w_k] = liegroup_variational_integrator(f, B, g_0, twist_0, u_k, t_k, sigma, options)
%LIEGROUP_VARIATIONAL_INTEGRATOR Summary of this function goes here
arguments
    f
    B
    g_0
